...
<!-- ea6153 -->
			<div class="col-sm-10 col-md-10" bgcolor-tengah>
				<div class="col-sm-10 col-md-10" style="margin-left: 10px; margin-top: 10px;">
					<center><h5 style="padding-top: 2px; margin-left: 2px;">UBAH PASSWORD</h5>
					<p class="all-text">Password maximum 8 character alfanumerik (huruf alfabet dan angka). Selain alfanumerik tidak berlaku. </p></center>

					<table class="table table-border table-jadwal-dosen" style="margin-left: 20%;">
						<tr>
							<td align="center" style="background: #ea6153;">Password Lama: </td>
							<td align="center">
								<input type="text" class="form-control" id="pass_id">
							</td>
						</tr>
						<tr>
							<td align="center" style="background: #ea6153;">Password Baru:</td>
							<td>
								<input type="text" class="form-control" id="pass_baru">
							</td>
						</tr>
						<tr>
							<td align="center" style="background: #ea6153;">Konfirmasi Password Baru: </td>
							<td>
								<input type="text" class="form-control" id="pass_baru">
							</td>
						</tr>
