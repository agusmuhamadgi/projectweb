			...
			<div class="col-sm-10 col-md-10" bgcolor-tengah>
				<div class="col-sm-10 col-md-10" style="margin-left: 10px; margin-top: 10px;">
					<form>
						<div class="form-row">
							...
							<div class="form-group">
								<h5 style="padding-top: 2px; margin-left: 2px;">INFO KURIKULUM</h5>
							</div>
						</div>						
					</form>	
					<hr>
				...
				<div>
					<table class="table table-border table-jadwal-dosen" style="margin-left: 20%;">
						<tr>
							<td align="center" class="bggreen">PILIH TAHUN KURIKULUM</td>
						</tr>
						<tr>
							<td align="center">
								<select class="table-jadwal-dosen">
									<option>PTS</option>
									<option>PTK</option>
									<option>2019</option>
									<option>2016</option>
				...
				<button type="submit" class="btn .btn-pracetak" style="margin-left: 40%">TAMPILKAN</button>
			</div>
		</div>
	</div>
</body>
