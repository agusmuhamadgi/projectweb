		...
		<div class="row">
			...
			<div class="col-sm-10">
				<div class="col-sm-10 col-md-10" style="margin-left: 10px; margin-top: 10px;">
					<form>
						<div class="form-row">
							...
							<div class="form-group">
								<h5 style="padding-top: 2px; margin-left: 2px;">INPUT KRS</h5>
							</div>
						</div>						
					</form>	
				...
				<div>
					<center>
						<br>
						<p class="thick">Sesi Pengisian KRS</p>
						<P class="thick">TIDAK ADA JADWAL PENGISIAN KRS</P>
					</center>
				</div>
			</div>
